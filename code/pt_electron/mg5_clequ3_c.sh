...
mkdir -p "/scratch/barbariczara/2026/mg5/C_${wils}/pp_cee/pt"

for pt in $(seq 20 5 500); do
	if [[ -d "/scratch/barbariczara/2026/mg5/C_${wils}/pp_cee/pt/pt_${pt}" ]]; then
		rm -r "/scratch/barbariczara/2026/mg5/C_${wils}/pp_cee/pt/pt_${pt}"
	fi
...
output /scratch/barbariczara/2026/mg5/C_${wils}/pp_cee/pt/pt_${pt}     
launch
0
