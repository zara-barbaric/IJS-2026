...
mkdir -p "${main}/mg5_shower/C_${wils}/pp_cee/pt"

for pt in $(seq 50 5 300); do
	if [[ -d "${main}/mg5_shower/C_${wils}/pp_cee/pt/pt_${pt}" ]]; then
		rm -r "${main}/mg5_shower/C_${wils}/pp_cee/pt/pt_${pt}"
	fi
...
output ${main}/mg5_shower/C_${wils}/pp_cee/pt/pt_${pt}     
launch
1
2
0
